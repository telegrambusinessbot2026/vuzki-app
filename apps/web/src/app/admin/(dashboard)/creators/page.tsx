...
import { Card, PageHeader, Tabs, StatusBadge, Badge, Button, Modal, Avatar, EmptyState, Th, Td, Toast, Loading, SearchInput } from '@/components/admin/ui';
import { Check, X, Eye, Star, Ban } from '@/components/admin/icons';
